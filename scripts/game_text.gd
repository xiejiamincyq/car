...
const TEXT_ROWS := [
	...
	["hud.ready", "就绪", "READY"],
	["hud.overdrive.ready", "超载  就绪", "OVERDRIVE  READY"],
	["hud.overdrive.active", "超载  {0}s", "OVERDRIVE  {0}s"],
	["hud.overdrive.cooldown", "超载  冷却 {0}s", "OVERDRIVE  COOLDOWN {0}s"],
	["hud.controls", "W/S 速度  双击W超载  A/D转向  Space暂停  M静音  |  种子 {0}", "W/S SPEED  DOUBLE W OVERDRIVE  A/D STEER  SPACE PAUSE  M MUTE  |  SEED {0}"],
	...
	["construction.warning.left", "前方施工 · 向左并线", "ROADWORK AHEAD · MERGE LEFT"],
	["construction.warning.right", "前方施工 · 向右并线", "ROADWORK AHEAD · MERGE RIGHT"],
	["construction.active.left", "施工路段 · 左侧通行", "ROADWORK · KEEP LEFT"],
	["construction.active.right", "施工路段 · 右侧通行", "ROADWORK · KEEP RIGHT"],
