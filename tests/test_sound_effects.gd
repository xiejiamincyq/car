...
func _init() -> void:
	...
	for effect in [SoundEffects.create_acceleration(), SoundEffects.create_pickup(), SoundEffects.create_warning(), SoundEffects.create_overdrive_ignition(), SoundEffects.create_overdrive_release()]:
